...
const int harmonicCount = 9;
const int radiosityTextureSizeX = radiosityProbeCountX * radiosityProbeCountY;
const int radiosityTextureSizeY = radiosityProbeCountZ * harmonicCount;